...
public class CalculatorTest {
    ...
    public static void testCalculateDiscount() {
        ...
        assertThatThrownBy(() -> Calculator.calculatingDiscount(-50, 10)).isInstanceOf(IllegalArgumentException.class);

        assertThatThrownBy(() -> Calculator.calculatingDiscount(100, -5)).isInstanceOf(IllegalArgumentException.class);

        assertThatThrownBy(() -> Calculator.calculatingDiscount(100, 110)).isInstanceOf(IllegalArgumentException.class);
    }
}